...
public class UserBase {
    ...
    // EFFECTS: Creates an object in JSON with the key "users". The value is an
    // array of all the users registered in the userbase
    ...
    // EFFECTS: Returns all the users registered in the userbase
    public ArrayList<User> getUsers() {
        return users;
    }

    // EFFECTS: Returns the number of users in th database
