...
public class User {
    ...
    // EFFETS: Returns the user's password 
    ...
    // EFFECTS: Sets the user's username to be equal to the given name
    public void setUserName(String userName) {
        this.userName = userName;
    }

    // EFFECTS: Returns the total number of solves completed by the user across all
    // practice sessions
    ...
    // EFFECTS: Returns all the practice sessions the user currently has
